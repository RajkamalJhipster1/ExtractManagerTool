...
import io.github.jhipster.application.ExtractManagerToolApp;
...
public class ExtractOrganisationResourceIntTest {
    ...
    public void createExtractOrganisation() throws Exception {
        ...
        assertThat(testExtractOrganisation.isDeleted()).isEqualTo(DEFAULT_DELETED);
        assertThat(testExtractOrganisation.isDisabled()).isEqualTo(DEFAULT_DISABLED);
        assertThat(testExtractOrganisation.isIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
    ...
    public void updateExtractOrganisation() throws Exception {
        ...
        assertThat(testExtractOrganisation.isDeleted()).isEqualTo(UPDATED_DELETED);
        assertThat(testExtractOrganisation.isDisabled()).isEqualTo(UPDATED_DISABLED);
        assertThat(testExtractOrganisation.isIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
